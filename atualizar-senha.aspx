<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="atualizar-senha.aspx.cs" Inherits="atualizar_senha" %>
        ...
        <div class="column-2 w-col w-col-3">
          ...
          <div class="cnt-perfil ctn-conta w-container">
            <div class="div-block-7 divblockconta">
              <h4 class="heading-2">Senha</h4>
              <p class="paragraph">Atualize sua senha.</p>
            </div>
